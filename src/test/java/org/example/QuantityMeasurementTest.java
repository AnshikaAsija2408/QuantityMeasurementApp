...
//                temp.convertTo(TemperatureUnit.FAHRENHEIT);
//
//        assertEquals(-40.0, result.getValue());
//    }
//
//    @Test
...
//                converted.convertTo(TemperatureUnit.CELSIUS);
//
//        assertEquals(
//                original.getValue(),
//                back.getValue(),
...
void testQuantityEntity_BinaryOperandConstruction() {
    ...
    assertEquals(q1, entity.getThisQuantity());

    assertEquals(q2, entity.getThatQuantity());
    ...
    @Test
    void testRepository_SaveEntity_Success() {
        ...
        assertTrue(
                repository.findAll().contains(entity)
        );
    }

    @Test
    void testRepository_FindAll_NotEmpty() {
